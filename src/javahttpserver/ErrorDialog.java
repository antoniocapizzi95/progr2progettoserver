...
public class ErrorDialog extends javax.swing.JDialog {
     ...
     */
    public ErrorDialog(java.awt.Frame parent, boolean modal, String errorText) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGap(49, 49, 49)
                .addComponent(errorLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 56, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ErrorDialog dialog = new ErrorDialog(new javax.swing.JFrame(), true, null);
